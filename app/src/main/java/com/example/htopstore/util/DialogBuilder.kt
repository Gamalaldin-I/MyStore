...
object DialogBuilder {
    ...
    fun showAddExpenseDialog(context: Context,onConfirm: (cat:String,des:String,amount:Double,method:String) -> Unit){
        ...
        val confirmBtn = this.addExpenseDialog?.findViewById<android.widget.Button>(R.id.confirmBtn)
        // set the adapters
        categoryEt?.setAdapter(GetAdapterOfOptionsUseCase.getExpenseCategoryAdapter(context))
        method?.setAdapter(GetAdapterOfOptionsUseCase.getPaymentMethodAdapter(context))
        // set the listeners
    ...
    fun showReturnDialog(context: Context,soldProduct: SoldProduct,onConfirm: (soldProduct: SoldProduct) -> Unit){
        ...
        // inflate the views
        val confirmBtn = this.returnDialog?.findViewById<android.widget.Button>(R.id.confirm)
        val numberPicker = this.returnDialog?.findViewById<android.widget.NumberPicker>(R.id.numberPicker)
